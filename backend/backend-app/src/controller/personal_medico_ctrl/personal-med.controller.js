...
import { createUserAccount, agendarCitaUsuario, updateUserNormalAccount, createUserAccountFromPersMed } from '../../services/usuario_svc/user-account.svc.js';
...
export const createUserAccountCtrl = async (req, res) => {
    ...
    try {
        ...
        const processResult = await createUserAccountFromPersMed(req.body);
        ...
        console.error("Error en controller createUserAccountCtrl >> " + error);
        return res.status(500).json(SERVER_ERROR);
    }
};
...
export const updateUserNormalAccountCtrl = async (req, res) => {
    ...
    try {
        ...
        console.error("Error en controller updateUserNormalAccountCtrl >> " + error);
        return res.status(500).json(SERVER_ERROR);
    }
};
