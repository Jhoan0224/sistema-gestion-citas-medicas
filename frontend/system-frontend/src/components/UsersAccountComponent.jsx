...
function UserCitaPendiente({userData, userHasCita, citaPendiente}) {
    ...
    <div>       
        ...
        <div className="ps-3 mb-3">
            ...
            <p className="mt-0 ms-3">{citaPendiente?.motivo}</p>

            <p className="mb-0"><b>Fecha y Hora de Atencion:</b></p>
            <p className="mt-0 ms-3">{new Date(Date.parse(citaPendiente?.fecha_hora_atencion))?.toLocaleString(undefined, optionsDate)}</p>

            <p className="mb-0"><b>Espcialidad medica:</b></p>
            <p className="mt-0 ms-3">{citaPendiente?.especialidad}</p>
