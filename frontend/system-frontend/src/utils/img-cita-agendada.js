...
const CENTER_HEALT_PHONE_EMAILS = "Email: sgcm.contact@sgcm.healt";
...
export async function ImageCitaAgendadaSave(userData, citaInfo) {
  ...
  await new Promise((resolve) => {
    ...
    img.onload = () => {
      ...
      ctx.font = FONT_1;
      ctx.fillText(`${new Date(Date.parse(citaInfo?.fecha_hora_atencion))?.toLocaleString(undefined, optionsDate)}`,
